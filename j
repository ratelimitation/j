/**
* @name SadNiggaThemeV2
* @version Auto Update
* @description creator
* @author creator#7570
* @invite wider
* @Source https://bigblackmen.com
...
--theme-background-image: url('https://i.imgur.com/jQoCn8W.gif');
--home-icon-image: url('https://i.imgur.com/Bx8OT3i.gif');
...
--small-user-popout-background-image: url('https://i.imgur.com/JOgsCTV.gif');
--small-user-popout-background-transparency: #00000099;
--small-user-popout-background-image-position: center;
--big-user-popout-background-image: url('https://i.imgur.com/OCFMdLu.gif');
